/*
  ...
  - You are about to drop the column `composer` on the `Track` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `remixArtist` on the `Track` table. All the data in the column will be lost.
  - You are about to drop the column `timing` on the `Track` table. All the data in the column will be lost.
